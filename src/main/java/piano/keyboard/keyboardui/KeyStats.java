...
public interface KeyStats {
    ...
    int FIRST_BLACK = (WHITE_WIDTH) - (BLACK_WIDTH / 2);
    int SPACE_BETWEEN_BLACK_KEYS = WHITE_WIDTH - BLACK_WIDTH;
    int BIG_SPACE_BETWEEN_BLACK_KEYS = 2 * (WHITE_WIDTH) - BLACK_WIDTH;
}
